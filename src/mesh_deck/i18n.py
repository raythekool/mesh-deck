...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "CMD_DESC_DEVICE_SETTINGS": {
        "it": "Gestisce in sicurezza l'identità del dispositivo radio collegato",
        "en": "Safely manage the connected radio device identity",
    },
    "NEIGHBORS_EMPTY": {
    ...
    "DEVICE_SETTINGS_TITLE": {"it": "⚙ MESH-DECK // IMPOSTAZIONI DISPOSITIVO", "en": "⚙ MESH-DECK // DEVICE SETTINGS"},
    "DEVICE_SETTINGS_SUBTITLE": {"it": "Draft locale, diff e conferma esplicita", "en": "Local draft, diff, and explicit confirmation"},
    "DEVICE_SETTINGS_GROUPS_TITLE": {"it": "GRUPPI", "en": "GROUPS"},
    "DEVICE_SETTINGS_GROUP_IDENTITY": {"it": "● Identità", "en": "● Identity"},
    "DEVICE_SETTINGS_GROUP_RADIO_LOCKED": {"it": "○ Radio (prossimamente)", "en": "○ Radio (coming soon)"},
    "DEVICE_SETTINGS_GROUP_POSITION_LOCKED": {"it": "○ Posizione (prossimamente)", "en": "○ Position (coming soon)"},
    "DEVICE_SETTINGS_GROUP_CHANNELS_LOCKED": {"it": "○ Canali (prossimamente)", "en": "○ Channels (coming soon)"},
    "DEVICE_SETTINGS_IDENTITY_TITLE": {"it": "IDENTITÀ DISPOSITIVO / DRAFT LOCALE", "en": "DEVICE IDENTITY / LOCAL DRAFT"},
    "DEVICE_SETTINGS_LONG_NAME": {"it": "Nome lungo", "en": "Long name"},
    "DEVICE_SETTINGS_SHORT_NAME": {"it": "Nome breve (massimo 4 caratteri)", "en": "Short name (maximum 4 characters)"},
    "DEVICE_SETTINGS_SNAPSHOT": {"it": "Snapshot letto dal nodo {node}. Nessuna modifica è ancora stata inviata.", "en": "Snapshot read from node {node}. No change has been sent yet."},
    "DEVICE_SETTINGS_NO_CHANGES": {"it": "Nessuna modifica da applicare.", "en": "No changes to apply."},
    "DEVICE_SETTINGS_DIFF": {"it": "Nome lungo: {old_long} → {new_long}\nNome breve: {old_short} → {new_short}", "en": "Long name: {old_long} → {new_long}\nShort name: {old_short} → {new_short}"},
    "DEVICE_SETTINGS_REVERT": {"it": "Ripristina draft", "en": "Revert draft"},
    "DEVICE_SETTINGS_REVIEW": {"it": "Rivedi modifica", "en": "Review change"},
    "DEVICE_SETTINGS_CONFIRM_TITLE": {"it": "CONFERMA MODIFICA IDENTITÀ", "en": "CONFIRM IDENTITY CHANGE"},
    "DEVICE_SETTINGS_CONFIRM_DIFF": {"it": "Il dispositivo radio riceverà:\n\nNome lungo: {old_long} → {new_long}\nNome breve: {old_short} → {new_short}\n\nLa modifica sarà inviata solo dopo Applica.", "en": "The radio device will receive:\n\nLong name: {old_long} → {new_long}\nShort name: {old_short} → {new_short}\n\nThe change is sent only after Apply."},
    "DEVICE_SETTINGS_CANCEL": {"it": "Annulla", "en": "Cancel"},
    "DEVICE_SETTINGS_APPLY": {"it": "Applica al dispositivo", "en": "Apply to device"},
    "DEVICE_SETTINGS_VALIDATION_LONG_REQUIRED": {"it": "Il nome lungo è obbligatorio.", "en": "Long name is required."},
    "DEVICE_SETTINGS_VALIDATION_LONG_LENGTH": {"it": "Il nome lungo può avere al massimo 39 caratteri.", "en": "Long name can be at most 39 characters."},
    "DEVICE_SETTINGS_VALIDATION_SHORT_REQUIRED": {"it": "Il nome breve è obbligatorio.", "en": "Short name is required."},
    "DEVICE_SETTINGS_VALIDATION_SHORT_LENGTH": {"it": "Il nome breve può avere al massimo 4 caratteri.", "en": "Short name can be at most 4 characters."},
    "DEVICE_SETTINGS_APPLIED": {"it": "Identità inviata al dispositivo e snapshot aggiornato.", "en": "Identity sent to device and snapshot refreshed."},
    "DEVICE_SETTINGS_ERROR": {"it": "Impossibile aggiornare il dispositivo: {error}", "en": "Could not update device: {error}"},
    "DEVICE_SETTINGS_NOT_CONNECTED": {"it": "Collega prima una radio per aprire le impostazioni dispositivo.", "en": "Connect a radio before opening device settings."},
    "DEVICE_SETTINGS_TUI_ONLY": {"it": "/device-settings è disponibile nella console Textual.", "en": "/device-settings is available in the Textual console."},
...
def command_descriptions(lang: str) -> dict[str, str]:
    ...
    return {
        ...
        "/history": t("CMD_DESC_HISTORY", lang),
